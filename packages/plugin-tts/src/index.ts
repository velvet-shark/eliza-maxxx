...
const TTSGeneration: Action = {
    ...
    handler: async (
        ...
        try {
            ...
            if (language && language.length > 0) {
                ...
                throw new Error(
                    "Language detection failed, no language detected."
                );
            }
        } catch (error) {
    ...
    examples: [
        [
            {
                user: "{{user1}}",
                content: { text: "Generate a TTS of prompt: Hello world!" },
            },
            {
                user: "{{agentName}}",
                content: {
        ...
        [
            {
                user: "{{user1}}",
                content: { text: "Please do TTS to a prompt: Sam is busy now" },
            },
            {
                user: "{{agentName}}",
                content: {
